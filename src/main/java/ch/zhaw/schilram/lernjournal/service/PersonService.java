...
public class PersonService {
    ...
    public List<Person> getAll() {
        ...
        String sql = "select id, firstname, lastname, money from person";
     ...
     */
    public void add(String firstName, String lastName, Integer money) {
        logger.debug("Adding new person");

        // Prepare our SQL statement using Named Parameters style
        String sql = "insert into person(firstname, lastname, money) values "
     ...
     */
    public void edit(Integer id, String firstName, String lastName, Integer money) {
        logger.debug("Editing existing person");

        // Prepare our SQL statement
        String sql = "update person set firstname = :firstName, lastname = :lastName, money = :money where id = :id";
